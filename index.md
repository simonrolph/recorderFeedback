...
- [`rf_dispatch_smtp()`](https://simonrolph.github.io/recorderFeedback/reference/rf_dispatch_smtp.md)
  sends emails with dry-run, resume, retries, and rate limiting.
...
[`rf_dispatch_smtp()`](https://simonrolph.github.io/recorderFeedback/reference/rf_dispatch_smtp.md)
now writes dispatch artifacts per batch:
...
[`rf_verify_batch()`](https://simonrolph.github.io/recorderFeedback/reference/rf_verify_batch.md)
will show you for which recipients the rendering failed. Using
`targets::tar_meta(fields = "error")` will also tell you which targets
failed and the corresponding error messages. Use
