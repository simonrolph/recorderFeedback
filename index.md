...
When you initialise a project with
[`rf_init()`](https://simonrolph.github.io/recorderFeedback/reference/rf_init.md),
files are copied to set up your workflow, ensuring you have all the
necessary templates, scripts, and configuration to get started quickly.
