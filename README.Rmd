...
`r badger::badge_devel("simonrolph/recorderFeedback", "blue")`

`r badger::badge_github_actions("simonrolph/recorderFeedback")`

`recorderFeedback` is an R package for generating personalised, data-driven feedback.

It was built for wildlife recording and citizen science projects, where teams want to give contributors useful feedback but cannot keep doing it by hand.
