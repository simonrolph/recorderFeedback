 ...
 * `scripts/computation.R`, `scripts/get_data.R`, `scripts/get_recipients.R`, `scripts/focal_filter.R`: Scripts for loading data, recipients, focal filtering and running computations, matching the workflow steps outlined in the README.
