...
- **Email Dispatch**: Send feedback via email using SMTP with dry-run preflight,
  retry/backoff, rate limiting, and resumable batches.
 ...
 * `scripts/computation.R`, `scripts/get_data.R`, `scripts/get_recipients.R`, `scripts/focal_filter.R`, `scripts/recipient_select.R`: Scripts for loading data, recipients, focal filtering, optional batch selection, and running computations, matching the workflow steps outlined in the README.
